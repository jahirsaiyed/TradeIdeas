...
@RestController
@RequestMapping("/api/trade-ideas-kafka")
public class TradeIdeasKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TradeIdeasKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TradeIdeasKafkaResource(KafkaProperties kafkaProperties) {
